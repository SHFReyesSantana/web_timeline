...
odoo.define("web_timeline.TimelineRenderer", function (require) {
    ...
    const TimelineRenderer = AbstractRenderer.extend({
                ...
                init_timeline: function () {
                    ...
                    const group_bys = []
                    group_bys.push(this.arch.attrs.default_group_by.split(","));
                    group_bys.push(this.arch.attrs.default_group_by_2.split(","));
                    const colors = this.arch.attrs.colors.split(",");
                    this.last_group_bys = group_bys;
                    this.last_colors = colors;
                ...
                event_data_transform: function (evt) {
                    ...
                    const color_stage = [];
                    const group2 = evt[this.last_colors]
                    if (group2) {
                        const value = JSON.parse(group2);
                        color_stage.push({
                            color: value[0].color,
                    ...
                    for (const color of color_stage) {
